...
public static class WebApplicationBuilderExtensions
{
    ...
    extension(WebApplicationBuilder builder)
    {
        ...
        public WebApplicationBuilder UseIdevsAutofac()
        {
        ...
        /// <returns>The updated web application builder</returns>
        public WebApplicationBuilder UseIdevsAutofac(params Autofac.Module[] modules)
        {
            // Configure Autofac as the service provider factory
            builder.Host.UseServiceProviderFactory(new AutofacServiceProviderFactory());
        ...
        /// <returns>The updated web application builder</returns>
        public WebApplicationBuilder UseIdevsAutofac(Action<ContainerBuilder> containerConfiguration)
        {
            // Configure Autofac as the service provider factory
            builder.Host.UseServiceProviderFactory(new AutofacServiceProviderFactory());
